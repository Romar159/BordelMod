...
public class TileEntityMachineBordel extends TileEntity implements IInventory{
	
	private ItemStack[] contents = new ItemStack[4]; //0 ; 1 ; 2 = Inputs | 3 = Output
    ...
    @Override
    public String getInventoryName() { //On ne peut pas mettre de nom custom !
        return "tile.machineBordel";
    }
    ...
    private boolean canSmelt()
    {
        ...
        {
            ItemStack itemstack = MachineBordelRecipes.smelting().getSmeltingResult(new ItemStack[]{this.contents[0], this.contents[1], this.contents[2]});
            ...
            return result <= getInventoryStackLimit() && result <= this.contents[3].getMaxStackSize(); //Et là aussi
        }
    }
    ...
    public void smeltItem()
    {
        if (this.canSmelt())
        {
            ItemStack itemstack = MachineBordelRecipes.smelting().getSmeltingResult(new ItemStack[]{this.contents[0], this.contents[1], this.contents[2]}); //On récupère l'output de la recette
