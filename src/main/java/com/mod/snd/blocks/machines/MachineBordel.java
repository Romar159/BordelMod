...
public class MachineBordel extends BlockContainer {

	public MachineBordel(Material material, int level) {
		super(material);
		this.setHarvestLevel("pickaxe", level);
		this.setResistance(8.0F);
	    
	    this.setBlockTextureName(Reference.MOD_ID + ":bordel_furnace"); 
	    // ... autres attributs.
    ...
    {
        return new TileEntityMachineBordel();
    }
